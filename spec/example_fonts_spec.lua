...
describe("example fonts", function()
	...
	it("maps example typography to role-specific fonts", function()
		...
		assert.are.equal("dev/assets/fonts/Google_Sans/GoogleSans-Regular.ttf", theme.fonts.body.source)
		assert.are.equal("dev/assets/fonts/Google_Sans/GoogleSans-Regular.ttf", theme.fonts.title.source)
		assert.are.equal("dev/assets/fonts/Google_Sans/GoogleSans-Regular.ttf", theme.fonts.description.source)
		assert.are.equal("dev/assets/fonts/Inconsolata/Inconsolata-Regular.ttf", theme.fonts.mono.source)

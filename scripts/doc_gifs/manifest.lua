      ...
      ui.feedback.define("docs.pop", {
        {
          kind = "parallel",
          steps = {
            { kind = "animate", to = { scale = 1.18, y = -8, rotation = -0.025 }, duration = 0.08, ease = "quadout" },
        ...
        panel("triggerable sequence", { flex = 1, height = 308, gap = 10 }, {
          ui.stack({ width = "100%", height = 194 }, {
            ...
            ui.button({
              ...
              style = {
                background = activeCount > 0 and cloneColor(palette.teal, 0.42) or cloneColor(palette.teal, 0.24),

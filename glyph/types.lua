...
---@field triangle fun(self: GlyphDrawContext, mode: "fill"|"line"|string, cx: number, cy: number, width: number, height: number)
---@field triangleEquilateral fun(self: GlyphDrawContext, mode: "fill"|"line"|string, cx: number, cy: number, width: number)
---@field arc fun(self: GlyphDrawContext, mode: "fill"|"line"|string, x: number, y: number, radius: number, a1: number, a2: number, arctype?: "pie"|"open"|"closed")
---@field roundedRect fun(self: GlyphDrawContext, mode: "fill"|"line"|string, cx: number, cy: number, width: number, height: number, radius?: number)
---@field dashedLine fun(self: GlyphDrawContext, x1: number, y1: number, x2: number, y2: number, dashSize: number, gapSize: number)
---@field dashedRectangle fun(self: GlyphDrawContext, cx: number, cy: number, width: number, height: number, dashSize: number, gapSize: number)
---@field roundedLine fun(self: GlyphDrawContext, x1: number, y1: number, x2: number, y2: number, width: number)

...
<!-- glyph:feature-gif i18n -->
![Animated GIF showing Glyph localized text, labels, placeholders, and cache-aware values.](assets/feature-gifs/i18n.gif)
<!-- /glyph:feature-gif i18n -->
...
Accessibility semantics use the same pattern, so labels and spoken values stay
localized without hard-coding strings in adapters:
...
changes. It also switches across Japanese, Arabic, Armenian, Georgian, Hebrew,
Mahajani, Thai, Korean, and Amharic samples to exercise example font fallbacks.
